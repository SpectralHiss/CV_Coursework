...
for r = 1:new_height
    for c = 1:new_width
        ...
        % Below version terminates in < 10 secs
        back_to_origin = new_center_to_origin*[r;c;1];
        inv_rotate_skew = (transpose(back_to_origin))* invM;
        pos = back_to_base * transpose(inv_rotate_skew);
